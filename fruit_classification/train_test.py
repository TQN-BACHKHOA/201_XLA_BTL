...
clf3 = GaussianNB() #This Naive Bayes
...
for testing_name in test_labels:
    ...
    for x in range(1, images_per_class + 1): #image_per_class = 80
...
for x in range(1, 11):
    ...
    print(train_labels[y_pred])
    cv2.putText(image, train_labels[y_pred], (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 255), 1)
